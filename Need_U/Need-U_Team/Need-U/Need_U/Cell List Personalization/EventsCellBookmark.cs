...
{
    public class EventsCellBookmark : ViewCell
    
         {

        public EventsCellBookmark()

        {
            ...
            moreAction.Clicked += async (sender, e) =>
            {
                ...
                var Event = (sender as Xamarin.Forms.MenuItem).BindingContext as EntityEvent;
                ...
                await new RestFavorite().FavoriteEventDelete(Event.IdEvent, Event.IdUser.Value);
