...
{
    class QuestionsCellBookmark : ViewCell
    {
        public QuestionsCellBookmark()

        {
            ...
            farAwayPreview.SetBinding(Label.TextProperty, new Binding("Description"));
            ...
            var moreAction = new MenuItem { Text = "Delete",};

            moreAction.Clicked +=  async (sender, e) =>
            {
             
                var question = (sender as Xamarin.Forms.MenuItem).BindingContext as EntityQuestion;
                ...
                await new RestFavorite().FavoriteQuestionDelete(question.IdQuestion, question.IdUser.Value);
